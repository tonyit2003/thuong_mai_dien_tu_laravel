...
<form action="{{ route('widget.destroy', $widget->id) }}" method="post" class="box">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    <div class="panel-title">
                        {{ __('confirm.delete_widget') }}
                    </div>
                    <div class="panel-description">
                        <p>{!! __('confirm.delete_widget_name', ['name' => $widget->name]) !!}</p>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input readonly type="text" name="name"
                                        value="{{ old('name', $widget->name ?? '') }}" class="form-control"
        ...
        <div class="text-right mb15">
            <input class="btn btn-danger" type="submit" name="send" value="{{ __('button.delete_widget') }}" />
        </div>
    </div>
</form>
