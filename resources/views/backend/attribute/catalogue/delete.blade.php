    ...
    <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    <div class="panel-title">
                        {{ __('confirm.delete_attribute_catalogue') }}
                    </div>
                    <div class="panel-description">
                        <p>{!! __('confirm.delete_attribute_catalogue_name', ['name' => $attributeCatalogue->name]) !!}</p>
        ...
        <div class="text-right mb15">
            <input class="btn btn-danger" type="submit" name="send"
                value="{{ __('button.delete_attribute_catalogue') }}" />
        </div>
    </div>
</form>
