                                ...
                                @if (isset($activeLanguage))
                                    ...
                                    <ul class="uk-list uk-clearfix language-dropdown">
                                        @foreach ($languages as $key => $val)
                                            ...
                                            @endphp
                                            <li>
                                                <a href="{{ route('language.switchFrontend', ['id' => $val->id]) }}" title="{{ $val->name }}"
                ...
                <div class="uk-flex uk-flex-middle">
                    ...
                    <div class="header-form">
                        <form action="{{ route('product.search') }}" method="GET" class="uk-form form search-form">
                            ...
                            @endif
                            <div class="form-row">
                                <input type="text" name="keyword" class="input-text" value="{{ request('keyword') ?: '' }}"
                        ...
                        <div class="widget-toolbox uk-flex uk-flex-middle">
                            <div class="toolbox-item">
                                <a href="" title="" class="uk-flex uk-flex-bottom">
                                    ...
                                    <div class="toolbox-text">{{ __('homePage.compare') }}</div>
                                </a>
                            </div>
                            <div class="toolbox-item">
                                <a href="" title="" class="uk-flex uk-flex-bottom">
                                    ...
                                    <div class="toolbox-text">{{ __('homePage.favourite') }}</div>
                                ...
                                <div class="dropdown">
                                    <a href="#" class="uk-flex uk-flex-bottom dropdown-toggle">
                                        ...
                                        <div class="toolbox-text">
                                            {{ Auth::guard('customers')->check() ? Auth::guard('customers')->user()->name : __('info.account') }}
                                        </div>
                                    </a>
