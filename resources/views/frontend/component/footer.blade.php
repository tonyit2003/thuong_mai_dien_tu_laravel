                            ...
                            <div class="fanpage">
                                <div class="fb-page" data-href="{{ $system['social_facebook'] }}" data-tabs=""
                                    ...
                                    <blockquote cite="{{ $system['social_facebook'] }}" class="fb-xfbml-parse-ignore">
                                        <a target="_blank" href="{{ $system['social_facebook'] }}">Facebook</a>
                                    </blockquote>
                                </div>
                            </div>
                        </div>
            ...
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                ...
                <div class="copyright-contact">
                    <div class="uk-flex uk-flex-middle">
                        ...
                        <div class="phone-item">
                            <div class="p">{{ __('configuration.support') }}: {{ $system['contact_sell_phone'] }}
                            </div>
                        ...
                        <div class="social-list">
                            ...
                            <div class="uk-flex uk-flex-middle">
                                @foreach ($socials as $item)
                                    <a target="_blank" href="{{ $system['social_' . $item] }}" class="">
